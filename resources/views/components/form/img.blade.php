<div class="">
	@include('utilities.forms.label', ['for' => '{{$type}}/imgs', 'name' => '画像'])
	<div class="mx-auto rounded-lg bg-lettuce-100 p-2 grid grid-cols-2 grid-rows-2 gap-2 js-img-container">
		@include('components.form.img_item')
	</div>
	<div>
		@include('components.form.img_addbutton')
	</div>
	@if($errors->$type->has('imgs.*'))
		@include('utilities.forms.alert', ['message' => $errors->first('imgs.*')])
	@endif
</div>
