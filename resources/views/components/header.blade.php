...
<meta property="og:title" content="{{$title ?? 'Orchards'}}">
...
<link rel="stylesheet" href="{{asset('css/app.css?20210331')}}">
<link rel="stylesheet" href="{{asset('/css/tagify.css')}}">
<link rel="stylesheet" href="{{asset('/css/style.css?20210331')}}">
...
<script src="{{asset('/js/script.js?20210313')}}" defar></script>
